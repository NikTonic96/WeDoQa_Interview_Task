...
import static com.saucedemo.pages.LogInPage.password;
import static com.saucedemo.pages.LogInPage.username;
...
public class AddToCart_StepDefinition {
    ...
    public void user_is_logged_in() {
        ...
        loginStepDefinitions.theUserEntersLoginCredentialsPassword(username, password);
    }
    ...
    public void the_user_should_see_the_correct_amount_of_items_in_the_cart() {
        Assert.assertEquals("Cart badge is not updated correctly !!", "1", homePage.shoppingCartBadge.getText());
    }
    ...
    public void theCorrectAmountOfItemsArePresent() {
        Assert.assertEquals("The cart amount is incorrect !!", 2, cartPage.listOfItemsInCart.size());
    }
}